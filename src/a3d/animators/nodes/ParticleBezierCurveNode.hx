...
import a3d.animators.states.ParticleBezierCurveState;
...
{
	/** @private */
	public static inline var BEZIER_CONTROL_INDEX:Int = 0;

	/** @private */
	public static inline var BEZIER_END_INDEX:Int = 1;
