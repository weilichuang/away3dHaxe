package a3d.animators.nodes
{
	...
	import a3d.animators.states.ParticleFollowState;
	...
	class ParticleFollowNode extends ParticleNodeBase
	{
		 ...
		 */
		public function ParticleFollowNode(usesPosition:Bool = true, usesRotation:Bool = true, smooth:Bool = false)
		{
