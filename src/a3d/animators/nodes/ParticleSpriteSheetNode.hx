package a3d.animators.nodes
{
	...
	class ParticleSpriteSheetNode extends ParticleNodeBase
	{
		 ...
		 */
		public function ParticleSpriteSheetNode(mode:UInt, usesCycle:Bool, usesPhase:Bool, numColumns:Int = 1, numRows:UInt = 1, cycleDuration:Float = 1, cyclePhase:Float = 0, totalFrames:UInt =
			uint.MAX_VALUE)
		{
			var len:Int;
			if (usesCycle)
