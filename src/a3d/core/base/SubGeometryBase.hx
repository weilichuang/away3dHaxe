...
class SubGeometryBase
{
	...
	private inline function set_autoGenerateDummyUVs(value:Bool):Bool
	{
	...
	private inline function set_autoDeriveVertexNormals(value:Bool):Bool
	{
	...
	private inline function set_useFaceWeights(value:Bool):Bool
	{
	...
	private inline function set_autoDeriveVertexTangents(value:Bool):Bool
	{
	...
	private inline function set_parentGeometry(value:Geometry):Geometry
	{
