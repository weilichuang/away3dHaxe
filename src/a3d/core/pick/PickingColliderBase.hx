...
class PickingColliderBase
{
	...
	private function getCollisionNormal(indexData:Vector<UInt>, vertexData:Vector<Float>, triangleIndex:UInt, normal:Vector3D = null):Vector3D
	{
	...
	private function getCollisionUV(indexData:Vector<UInt>, uvData:Vector<Float>, 
									triangleIndex:UInt, 
									v:Float, w:Float, u:Float, 
									uvOffset:UInt, uvStride:UInt,
									uv:Point = null):Point
	{
