package a3d.materials
{
	...
	*/
	...
	class SpriteSheetMaterial extends TextureMaterial
	{
		...
		* @param smooth 		Bool : Material smoothing. Default is true.
		* @param repeat 		Bool : Material repeat. Default is false.
		* @param mipmap 		Bool : Material mipmap. Set it to false if the animation graphics have thin lines or text information in them. Default is true.
		*/

		public function SpriteSheetMaterial(diffuses:Vector<Texture2DBase>,
