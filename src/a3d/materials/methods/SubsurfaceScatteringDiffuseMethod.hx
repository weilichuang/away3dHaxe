package a3d.materials.methods
{
	...
	class SubsurfaceScatteringDiffuseMethod extends CompositeDiffuseMethod
	{
		 ...
		 */
		public function SubsurfaceScatteringDiffuseMethod(depthMapSize:Int = 512, depthMapOffset:Float = 15)
		{
			super(scatterLight);
		...
		private inline function set_scattering(value:Float):Void
		{
			_scattering = value;
		}
		...
		private inline function set_translucency(value:Float):Void
		{
			_translucency = value;
		}
		...
		private inline function set_scatterColor(scatterColor:UInt):Void
		{
