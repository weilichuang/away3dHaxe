package a3d.textures
{
	...
	class WebcamTexture extends BitmapTexture
	{
		...
		public function WebcamTexture(cameraWidth:UInt = 320, cameraHeight:UInt = 240, materialSize:UInt = 256, autoStart:Bool = true, camera:Camera = null, smoothing:Bool = true)
		{
		...
		*/
		...
		private inline function set_smoothing(value:Bool):Void
		{
			_smoothing = value;
		}
