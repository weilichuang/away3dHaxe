package a3d.textures
{
	...
	class VideoTexture extends BitmapTexture
	{
		...
		public function VideoTexture(source:String, materialWidth:UInt = 256, materialHeight:UInt = 256, loop:Bool = true, autoPlay:Bool = false, player:IVideoPlayer = null)
		{
		 ...
		 */
		private inline function set_autoPlay(b:Bool):Void
		{
			_autoPlay = b;
		}
		...
		private inline function set_materialWidth(value:UInt):Void
		{
		...
		private inline function set_materialHeight(value:UInt):Void
		{
