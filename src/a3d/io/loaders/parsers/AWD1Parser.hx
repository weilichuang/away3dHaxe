...
/**
 * AWD1Parser provides a parser for the AWD data type. The version 1.0 in ascii. Usually generated by Prefab3D 1.x and a3d engine exporters.
 */
class AWD1Parser extends ParserBase
{
	...
	public static function supportsData(data:Dynamic):Bool
	{
		...
		else
		{
			...
			str2 = Std.is(data,String) ? Std.instance(data,String).substr(0, readLength) : null;
		}
