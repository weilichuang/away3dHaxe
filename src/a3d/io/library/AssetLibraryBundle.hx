...
import a3d.io.library.naming.ConflictPrecedence;
import a3d.io.library.naming.ConflictStrategy;
import a3d.io.library.naming.ConflictStrategyBase;
import a3d.io.library.utils.AssetLibraryIterator;
import a3d.io.library.utils.IDUtil;
 ...
 */
@:meta(Event(name = "resourceComplete", type = "a3d.events.LoaderEvent"))
 ...
 * @eventType a3d.events.LoaderEvent
 */
@:meta(Event(name = "dependencyComplete", type = "a3d.events.LoaderEvent"))
 ...
 */
@:meta(Event(name = "geometryComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "skeletonComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "skeletonPoseComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "containerComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "animationSetComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "animationStateComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "animationNodeComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "stateTransitionComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "textureComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "materialComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "animatorComplete", type = "a3d.events.AssetEvent"))
 ...
 * @eventType a3d.events.AssetEvent
 */
@:meta(Event(name = "textureSizeError", type = "a3d.events.AssetEvent"))
