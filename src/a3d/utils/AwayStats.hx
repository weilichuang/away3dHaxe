...
class AwayStats extends Sprite
{
	 ...
	 * respectively.
	 */
	public function new(view3d:View3D = null, minimized:Bool = false, transparent:Bool = false, meanDataLength:UInt = 0, enableClickToReset:Bool = true, enableModifyFrameRate:Bool =
		true)
	{
		super();
