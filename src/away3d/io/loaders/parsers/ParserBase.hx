 ...
 */
@:meta(Eventname = "parseComplete", type = "away3d.events.ParserEvent")
 ...
 * @eventType away3d.events.ParserEvent
 */
@:meta(Eventname = "readyForDependencies", type = "away3d.events.ParserEvent")
 ...
 * @eventType away3d.events.ParserEvent
 */
@:meta(Eventname = "parseError", type = "away3d.events.ParserEvent")
