package away3d.animators.nodes
{
	...
	public class ParticleOrbitNode extends ParticleNodeBase
	{
		 ...
		 */
		public function ParticleOrbitNode(mode:uint, usesEulers:Boolean = true, usesCycle:Boolean = false, usesPhase:Boolean = false, radius:Number = 100, cycleDuration:Number = 1, cyclePhase:Number =
