...
class LatheExtrude extends Mesh
{
	...
	* @param		coverall				[optional] Bool. The way the uv mapping is spreaded across the shape. True covers an entire side of the geometry while false covers per segments. Default is true.
	...
	* @param		preciseThickness	[optional] Bool. If the thickness must be repected along the entire volume profile. Default is true.
	...
	*/
	...
	private function generate(vectors:Vector<Vector3D>, axis:String, tweek:Object, render:Bool = true, id:UInt = 0):Void
	{
		// TODO: not used
		axis = axis;
	...
	private function buildThicknessPoints(aPoints:Vector<Vector3D>, thickness:Float, prop1:String, prop2:String):Array
	{
		var anchors:Array = [];
		var lines:Array = [];
		var i:Int;
