...
class Stage3DProxy extends EventDispatcher
{
	...
	*/
	...
	//private var _activeVertexBuffers : Vector<VertexBuffer3D> = new Vector<VertexBuffer3D>(Away3D.MAX_NUM_STAGE3D, true);
	//private var _activeTextures : Vector<TextureBase> = new Vector<TextureBase>(Away3D.MAX_NUM_STAGE3D, true);
