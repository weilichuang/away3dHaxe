...
class SubGeometryBase
{
	...
	public var hasSecondaryUVs(get, set):Bool;
	...
	private var _hasSecondaryUVs:Bool = false;
	 ...
	 */
	private inline function get_hasSecondaryUVs():Bool
	{
		return _hasSecondaryUVs;
	}
	
	private inline function set_hasSecondaryUVs(value:Bool):Bool
	{
		return _hasSecondaryUVs = value;
	}
	...
	private function invalidateBounds():Void
	{
		if (_parentGeometry != null)
			_parentGeometry.invalidateBounds(cast this);
	}
