 ...
 */
@:meta(Event(name = "positionChanged", type = "away3d.events.Object3DEvent"))
 ...
 * @eventType away3d.events.Object3DEvent
 */
@:meta(Event(name = "scaleChanged", type = "away3d.events.Object3DEvent"))
 ...
 * @eventType away3d.events.Object3DEvent
 */
@:meta(Event(name = "rotationChanged", type = "away3d.events.Object3DEvent"))
...
class Object3D extends NamedAssetBase
{
	...
	private var _sca:Vector3D = new Vector3D(1,1,1);
	 ...
	 * @param	sz
	 */
	public inline function setScaleXYZ(sx:Float, sy:Float, sz:Float):Void
	{
		_scaleX = sx;
		_scaleY = sy;
		_scaleZ = sz;
	 ...
	 */
	public inline function scale(value:Float):Void
	{
		_scaleX *= value;
		_scaleY *= value;
		_scaleZ *= value;
