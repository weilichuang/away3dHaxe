...
// var normals:Vector.<Number>;
    ...
    private function generate():Void {
        ...
        if (_thickness != 0) 
		{
            var aListsides:Vector<String> = Vector.ofArray(["top", "bottom", "right", "left", "front", "back"]);
...
//right
    ...
    private function addThicknessSubdivision(points1:Vector<Vertex>, points2:Vector<Vertex>, u1:Float, u2:Float, mat:MaterialBase):Void {
        var i:Int;
        var j:Int;
        var stepx:Float;
        var stepy:Float;
        ...
        var v1:Float = 0;
        var v2:Float = 0;
        var tmp:Vector<Vertex> = new Vector<Vertex>();
        i = 0;
    ...
    private function buildThicknessPoints(prop1:String, prop2:String):Vector<FourPoints> 
	{
    ...
    private function definelines(index:Int, point1:FourPoints, point2:FourPoints = null, 
								lines:Vector<FourPoints> = null):FourPoints 
	{
