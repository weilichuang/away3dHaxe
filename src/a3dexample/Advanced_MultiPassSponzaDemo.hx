package a3dexample
{
	...
	class Advanced_MultiPassSponzaDemo extends BasicApplication
	{
		...
		private var _materialNameStrings:Vector<String> = Vector<String>(["arch", "Material__298", "bricks", "ceiling", "chain", "column_a", "column_b", "column_c", "fabric_g", "fabric_c", "fabric_f",
		...
		private const _diffuseTextureStrings:Vector<String> = Vector<String>(["arch_diff.jpg", "background.jpg", "bricks_a_diff.jpg", "ceiling_a_diff.jpg", "chain_texture.png", "column_a_diff.jpg", "column_b_diff.jpg",
		...
		private const _normalTextureStrings:Vector<String> = Vector<String>(["arch_ddn.jpg", "background_ddn.jpg", "bricks_a_ddn.jpg", null, "chain_texture_ddn.jpg", "column_a_ddn.jpg", "column_b_ddn.jpg",
		...
		private const _specularTextureStrings:Vector<String> = Vector<String>(["arch_spec.jpg", null, "bricks_a_spec.jpg", "ceiling_a_spec.jpg", null, "column_a_spec.jpg", "column_b_spec.jpg", "column_c_spec.jpg",
		...
		//flame data objects
		private const _flameData:Vector<FlameVO> = Vector<FlameVO>([new FlameVO(new Vector3D(-625, 165, 219), 0xffaa44), new FlameVO(new Vector3D(485, 165, 219), 0xffaa44), new FlameVO(new Vector3D(-625,
		 ...
		 */
		public function get singlePassMaterial():Bool
		{
			return _singlePassMaterial;
		}

		public function set singlePassMaterial(value:Bool):Void
		{
		 ...
		 */
		public function get multiPassMaterial():Bool
		{
			return _multiPassMaterial;
		}

		public function set multiPassMaterial(value:Bool):Void
		{
			_multiPassMaterial = value;
			_singlePassMaterial = !value;
		 ...
		 */
		public function get lightDirection():Float
		{
			return _lightDirection * 180 / Math.PI;
		}

		public function set lightDirection(value:Float):Void
		{
		 ...
		 */
		public function get lightElevation():Float
		{
			return 90 - _lightElevation * 180 / Math.PI;
		}

		public function set lightElevation(value:Float):Void
		{
