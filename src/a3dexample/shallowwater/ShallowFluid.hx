package a3dexample.shallowwater
{
	...
	class ShallowFluid
	{
		...
		private var _k1:Float, _k2:Float, _k3:Float;
		...
		public function ShallowFluid(n:UInt, m:UInt, d:Float, t:Float, c:Float, mu:Float)
		{
			_width = n;
			_height = m;
			_spacing = d;
		...
		/*
		 ...
		 given position.
		 */
		public function displacePointStatic(n:UInt, m:UInt, displacement:Float):Void
		{
		...
		/*
		 ...
		 given amount.
		 */
		public function displacePoint(n:UInt, m:UInt, displacement:Float):Void
		{
			var index:int = _width * m + n;
			_points[_renderBuffer][3 * index + 2] += displacement;
			_points[1 - _renderBuffer][3 * index + 2] += displacement;
		 ...
		 */
		public function set speed(value:Float):Void
		{
		...
		/*
		 Viscosity.
		 */
		public function get viscosity():Float
		{
			return _viscosity;
		}

		public function set viscosity(value:Float):Void
		{
			_viscosity = value;
		 ...
		 */
		public function get gridWidth():Float
		{
			return _width;
		}

		public function get gridHeight():Float
		{
			return _height;
		}

		public function get gridSpacing():Float
		{
			return _spacing;
		}
