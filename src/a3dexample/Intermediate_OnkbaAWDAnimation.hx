package a3dexample
{
	...
	class Intermediate_OnkbaAWDAnimation extends BasicApplication
	{
		...
		private var textureStrings:Vector<String> = Vector<String>(["floor_diffuse.jpg", "floor_normals.jpg", "floor_specular.jpg", "onkba_diffuse.png", "onkba_normals.jpg", "onkba_lightmap.jpg", "gun_diffuse.jpg",
			"gun_normals.jpg", "gun_lightmap.jpg"]);
		...
		private const ROTATION_SPEED:Float = 3;
		private const RUN_SPEED:Float = 2;
		private const WALK_SPEED:Float = 1;
		private const BREATHE_SPEED:Float = 1;
		private const PUNCH_SPEED:Float = 1.6;
		private const DODGE_SPEED:Float = 1.5;
